...
public class ShapesDemo {
	...
	public static void demoPartOne() {
		...
		r3.move(6, 15);
		printResult("6", "" + r3.getX());
		printResult("15", "" + r3.getY());
		System.out.println("");
		...
		r4.scale(10, 3);
		printResult("20", "" + r4.getWidth());
		printResult("6", "" + r4.getHeight());
		System.out.println("");
		
		// largerThan
		System.out.println("Checking larger than:");
		
		printResult("false", "" + r3.largerThan(r4));
		System.out.println("");
		...
		printResult("20 x 6 rectangle at (1,1)", r4.toString());
		System.out.println("");
		...
		printResult("20 x 29 rectangle at (1, 1)", "" + boundR3R4);
		System.out.println("");
	}
	...
	public static void demoPartTwo() {
		...
		c3.move(-3,  -4);
		printResult("-3", "" + c3.getX());
		printResult("-4", "" + c3.getY());
		System.out.println("");
		...
		c4.scale(10);
		printResult("20", "" + c4.getRadius());
		System.out.println("");
		
		// largerThan
		System.out.println("Checking larger than:");
		printResult("true", "" + c1.largerThan(c2));
		printResult("false", "" + c3.largerThan(c4));
		System.out.println("");
		
		// toString
		System.out.println("Checking toString:");
		printResult("r = 6 circle at (4, 5)", c2.toString());
		printResult("r = 10 circle at (-3, -4)", c3.toString());
		System.out.println("");
		...
		printResult("40 x 40 rectangle at (68, 68)", "" + boundC4);
		System.out.println("");
		...
		printResult("121 x 122 rectangle at (-13, -14)", "" + boundC3C4);
		System.out.println("");
	}
